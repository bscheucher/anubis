...
public class AbwesenheitenV2IntegrationTest extends BaseIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        personalnummer = persistAndGetCompletePersonalnummer();
