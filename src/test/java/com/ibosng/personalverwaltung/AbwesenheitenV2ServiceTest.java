...
public class AbwesenheitenV2ServiceTest {
    ...
    @BeforeEach
    void setUp() {
        sut = new AbwesenheitenV2Service(abwesenheitRepositoryMock, lhrOutboxEntryRepositoryMock, new AbwesenheitMapperImpl());
    }
    ...
    public void persistsAbwesenheitAndLhrOutboxEntry() {
        ...
        when(abwesenheitRepositoryMock.save(any(Abwesenheit.class))).thenReturn(getMockPersistedAbwesenheit());
        ...
        assertThat(abwesenheitArgumentCaptor.getValue()).satisfies(a -> {
            ...
            assertThat(a.getGrund()).isNull();
            assertThat(a.getFuehrungskraefte()).isEmpty();
