...
public class VHSOptionalVornameValidation extends OptionalFieldValidator<TeilnehmerStaging, Teilnehmer> {

    public VHSOptionalVornameValidation(AbstractValidation<TeilnehmerStaging, Teilnehmer> teilnehmerVornameValidation) {
        super(teilnehmerVornameValidation);
    }
    ...
    public boolean setFieldsEmpty(TeilnehmerStaging objectT, Teilnehmer objectV) {
        return !isNullOrBlank(objectV.getVorname());
    }
}
