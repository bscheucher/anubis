package com.ibosng.validationservice.aspects;
...
public class LocalUrlAspect {
    ...
    @Around("execution(* com.ibosng.validationservice.services.RestService.sendRequest(..)) || " +
            "execution(* com.ibosng.validationservice.services.RestService.sendRequestParametrized(..))")
