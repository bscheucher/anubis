...
@ComponentScan(basePackages = {"com.ibosng.dbservice.services", "com.ibosng.dbservice.repositories", "com.ibosng.personalverwaltung.persistence"})
@EntityScan({"com.ibosng.dbservice.entities", "com.ibosng.personalverwaltung.persistence"})
