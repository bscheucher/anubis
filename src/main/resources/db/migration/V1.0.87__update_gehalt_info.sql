alter table gehalt_info rename column angerechnete_ibis_jahre to angerechnete_ibis_monate;
alter table gehalt_info_history rename column angerechnete_ibis_jahre to angerechnete_ibis_monate;
