alter table teilnehmer_staging add column ursprungsland varchar(255);
alter table teilnehmer_staging add column gerburtsort varchar(255);
alter table teilnehmer_staging add column erlaeuterung_ziel varchar(255);
alter table teilnehmer_staging add column vermittelbar_ab varchar(255);
alter table teilnehmer_staging add column notiz varchar(255);
alter table teilnehmer_staging_history add column ursprungsland varchar(255);
alter table teilnehmer_staging_history add column gerburtsort varchar(255);
alter table teilnehmer_staging_history add column erlaeuterung_ziel varchar(255);
alter table teilnehmer_staging_history add column vermittelbar_ab varchar(255);
alter table teilnehmer_staging_history add column notiz varchar(255);
